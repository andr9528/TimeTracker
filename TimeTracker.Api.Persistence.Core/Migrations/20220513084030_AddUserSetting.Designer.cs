...
namespace TimeTracker.Api.Persistence.Core.Migrations
{
    ...
    [Migration("20220513084030_AddUserSetting")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTracker.Api.Persistence.Core.Models.UserSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("TimeTracker.Api.Persistence.Core.Models.UserSetting", b =>
                {
                    b.HasOne("TimeTracker.Api.Persistence.Core.Models.User", "User")
                        .WithOne("Setting")
                        .HasForeignKey("TimeTracker.Api.Persistence.Core.Models.UserSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
